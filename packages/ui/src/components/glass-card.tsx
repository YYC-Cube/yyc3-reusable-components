...
export function GlassCard({
  ...
  const variantStyles = {
    ...
    highlight:
      'bg-gradient-to-br from-blue-500/20 to-purple-500/10 backdrop-blur-xl border-blue-500/30',
  };
  ...
  return (
    ...
    >
      ...
      {/* Inner glow */}
      <div
        className="absolute inset-0 rounded-2xl shadow-inner opacity-50 pointer-events-none"
...
export function GlassButton({
  ...
  const variantStyles = {
    primary:
      'bg-gradient-to-br from-blue-500/80 to-cyan-500/80 hover:from-blue-500/90 hover:to-cyan-500/90 text-white border-white/20',
    ...
    destructive:
      'bg-gradient-to-br from-red-500/80 to-rose-500/80 hover:from-red-500/90 hover:to-rose-500/90 text-white border-white/20',
  };
