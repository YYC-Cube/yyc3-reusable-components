...
const ASSETS = [
  {
    ...
    image:
      'https://images.unsplash.com/photo-1767385894916-b751898159d1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmR1c3RyaWFsJTIwY3JhbmUlMjBzY3JhcCUyMHlhcmR8ZW58MXx8fHwxNzcwMTg4OTkwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    id: 'AST-002',
    ...
    image:
      'https://images.unsplash.com/photo-1760933803441-f479b177f137?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxleGNhdmF0b3IlMjBzY3JhcCUyMG1ldGFsfGVufDF8fHx8MTc3MDE4ODk5MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    id: 'AST-003',
    ...
    image:
      'https://images.unsplash.com/photo-1598023707207-276835c2b5fe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmb3JrbGlmdCUyMGluZHVzdHJpYWx8ZW58MXx8fHwxNzcwMTg4OTk2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    id: 'AST-004',
    ...
    image:
      'https://images.unsplash.com/photo-1721745250100-7d777c1c48ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmR1c3RyaWFsJTIwbWV0YWwlMjBzaHJlZGRlciUyMG1hY2hpbmV8ZW58MXx8fHwxNzcwMTg4OTkxfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
  {
    id: 'AST-005',
    ...
    image:
      'https://images.unsplash.com/photo-1621273898430-1c430f134f8d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cnVjayUyMHNjYWxlJTIwd2VpZ2hicmlkZ2V8ZW58MXx8fHwxNzcwMTg4OTk2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  },
];
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-1">
              {currentLanguage === 'en'
                ? 'Track equipment value, depreciation, and maintenance'
                : '追踪设备价值、折旧与维护保养'}
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="glass-card rounded-2xl p-6 border border-white/10 relative overflow-hidden">
          ...
          <p className="text-gray-400 text-sm font-medium mb-1">
            {currentLanguage === 'en' ? 'Total Asset Value' : '资产总净值'}
          </p>
        ...
        <div className="glass-card rounded-2xl p-6 border border-white/10 relative overflow-hidden">
          ...
          <p className="text-gray-400 text-sm font-medium mb-1">
            {currentLanguage === 'en' ? 'Utilization Rate' : '设备利用率'}
          </p>
        ...
        <div className="glass-card rounded-2xl p-6 border border-white/10 relative overflow-hidden">
          ...
          <p className="text-gray-400 text-sm font-medium mb-1">
            {currentLanguage === 'en' ? 'Maintenance Due' : '待维护设备'}
          </p>
          <h3 className="text-2xl font-bold text-white">
            3 {currentLanguage === 'en' ? 'Units' : '台'}
          </h3>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 border border-white/10 relative overflow-hidden">
          ...
          <p className="text-gray-400 text-sm font-medium mb-1">
            {currentLanguage === 'en' ? 'Depreciation Exp' : '本年折旧额'}
          </p>
          ...
          <div className="glass-card rounded-2xl border border-white/10 overflow-hidden flex flex-col">
            <div className="p-6 border-b border-white/10 flex justify-between items-center bg-slate-800/20">
              <h3 className="text-lg font-bold text-white">
                {currentLanguage === 'en' ? 'Fleet & Equipment' : '设备清单'}
              </h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-2 mb-1">
                        <h4 className="text-white font-bold truncate">
                          {asset.name[currentLanguage as keyof typeof asset.name]}
                        </h4>
                      ...
                      <p className="text-sm text-gray-400 mb-2">
                        {asset.type[currentLanguage as keyof typeof asset.type]} • {asset.location}
                      </p>
                      <div className="flex items-center space-x-4 text-xs">
                        <div className="flex flex-col">
                          <span className="text-gray-500">
                            {currentLanguage === 'en' ? 'Original Value' : '原值'}
                          </span>
                        ...
                        <div className="flex flex-col">
                          <span className="text-gray-500">
                            {currentLanguage === 'en' ? 'Current Value' : '净值'}
                          </span>
                    ...
                    <div className="flex flex-col items-end space-y-2 shrink-0 w-full sm:w-auto">
                      <span
                        className={`inline-flex items-center space-x-1.5 px-2.5 py-1 rounded-full text-xs font-medium border ${statusConfig.color}`}
                      >
                      ...
                      <div className="text-xs text-gray-400 flex items-center">
                        ...
                        {currentLanguage === 'en' ? 'Next Service:' : '下次保养:'}{' '}
        ...
        <div className="space-y-6">
          <div className="glass-card rounded-2xl p-6 border border-white/10">
            <h3 className="text-lg font-bold text-white mb-4">
              {currentLanguage === 'en' ? 'Depreciation Forecast' : '折旧预测'}
            </h3>
          ...
          <div className="glass-card rounded-2xl p-6 border border-white/10 bg-gradient-to-br from-indigo-900/20 to-transparent">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h3 className="text-base font-bold text-white">
                {currentLanguage === 'en' ? 'Asset Distribution' : '资产分布'}
              </h3>
            </div>
