          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-green-500/30 bg-black">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <h3 className="text-xs font-bold text-green-500 uppercase tracking-widest truncate max-w-[200px]">
                  {artifact.title}
                </h3>
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-green-500/20 bg-green-500/5">
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="ghost"
                size="sm"
                className="h-6 text-[9px] font-bold text-green-500/40 hover:text-green-500 uppercase tracking-widest rounded-none"
              >
                ...
                >
                  {artifact.type === 'web' ? (
                    ...
                    <div className="text-center space-y-4">
                      ...
                      <p className="text-green-500/50 font-bold uppercase tracking-widest">
                        NO_PREVIEW_AVAILABLE
                      </p>
                      <Button
                        onClick={() => setViewMode('code')}
                        className="bg-green-500/10 text-green-500 border border-green-500/50 rounded-none hover:bg-green-500 hover:text-black"
                      >
                        VIEW_SOURCE
                      </Button>
                    </div>
