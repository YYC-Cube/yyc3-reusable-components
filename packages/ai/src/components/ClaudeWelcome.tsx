...
import { Terminal, Cpu, Code, Shield, Database, Send, Zap, Globe, Paperclip } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-transparent overflow-hidden font-mono text-green-500 selection:bg-green-500/30 selection:text-green-900">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 max-w-4xl mx-auto w-full pb-20 relative z-10">
        ...
        >
          <div
            className={`relative bg-black border-2 transition-all duration-300 ${isFocused ? 'border-green-500 shadow-[0_0_20px_rgba(34,197,94,0.2)]' : 'border-green-500/30'}`}
          >
            {/* Terminal Header */}
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-green-500/10">
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 text-green-500/40 hover:text-green-500 hover:bg-green-500/10 rounded-none"
                  >
          ...
          {commands.map((cmd, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-[9px] text-green-500/40 font-mono mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  ./{cmd.cmd}
                </span>
              </div>
            </button>
        ...
        <div className="fixed bottom-6 left-0 right-0 text-center pointer-events-none">
          <div className="flex items-center justify-center gap-6 text-[10px] text-green-500/30 font-bold uppercase tracking-[0.3em]">
            <span className="flex items-center gap-2">
              <Zap className="w-3 h-3" /> CORE: STABLE
            </span>
