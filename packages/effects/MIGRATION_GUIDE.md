...
- **源文件：**
  `项目源码/YYC3-AI-Management/src/app/components/particle-canvas.tsx`
- **大小：** 6.83 KB
...
- **源文件：**
  `项目源码/YYC3-AI-Management/src/app/components/cyberpunk-widget.tsx`
- **大小：** 23.67 KB
- **功能：** 复杂的赛博朋克风格组件
- **依赖：** 多个UI组件
- **迁移建议：** 低优先级（复杂度高）
...
1. **主题依赖：**
   所有组件都依赖`useApp`上下文，需要抽象为props或提供默认主题配置
